...
export class TokenAuthServiceProxy {
    ...
    authenticate(body: AuthenticateModel | undefined): Observable<AuthenticateResultModel> {
        ...
        let url_ = `${environment.apiUrl}/api/Authenticate/login`;
         url_ = url_.replace(/[?&]$/, "");
...
export class AuthenticateResultModel implements IAuthenticateResultModel {
    ...
    userName: string | undefined
    userSbpAllowed: boolean | undefined
    authAllowed: boolean | undefined
    insertAllowed: boolean | undefined
    ...
    init(data?: any) {
        if (data) {
            ...
            this.userName = data['userName']
            this.userSbpAllowed = data['userSbpAllowed']
    ...
    toJSON(data?: any) {
        ...
        data['userName'] = this.userName
        data['userSbpAllowed'] = this.userSbpAllowed
        data["authAllowed"] = this.authAllowed
        data["insertAllowed"] = this.insertAllowed
