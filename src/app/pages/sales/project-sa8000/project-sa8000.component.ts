...
export class ProjectSA8000Component implements OnInit {
  ...
  get f() { return this.SAForm.controls; }
  ...
  contractApproved(): void {
    ...
    if (this.SAForm.get('ContractStatusId').value == null || this.SAForm.get('ContractStatusId').value == undefined || this.SAForm.get('ContractStatusId').value == "" || this.SAForm.get('ContractStatusId').value == '' || this.SAForm.get('ContractStatusId').value == NaN) {
    ...
    foData.append('ApprovalStatusId', this.SAForm.get('ContractStatusId').value);
  ...
  UpdateProject() {
    ...
    this._SA8000Service.GetProjectSA8000BYId(this.ProjectId).subscribe(data => {
      ...
      if (data.clientSitesModel != null && data.clientSitesModel != "" && data.clientSitesModel != '' && data.clientSitesModel != undefined && data.clientSitesModel != NaN) {
        ...
        this.SAForm.controls.OutsourceProductionProcessess.setValue(ClientSiteData.outsourceProductionProcessess);
        this.SAForm.controls.ShiftTimings.setValue(ClientSiteData.shiftTimings);

        this.SAForm.controls.LegalStatus.setValue(ClientSiteData.legalStatus)
        this.SAForm.controls.TotalEmployees.setValue(ClientSiteData.totalEmployees)
     ...
     // this.SAForm.controls.ProjectTypeId.setValue(ClientProjectMod.projectTypeId);
      ...
      this.SAForm.controls.NoOfSurveillanceVisits.setValue(ProjectSaData.noOfSurveillanceVisits)

      this.SAForm.controls.PreAuditDuration.setValue(ProjectSaData.preAuditDuration);
      ...
      this.SAForm.controls.SurveillanceMethodId.setValue(ProjectSaData.surveillanceMethodId)

      this.SAForm.controls.SurveillanceVisitFrequencyId.setValue(ProjectSaData.surveillanceVisitFrequencyId);
      this.SAForm.controls.ApprovalStatusId.setValue(ClientProjectMod.approvalStatusId);
      ...
      if (this.AuditId != null && this.AuditId != undefined && this.AuditId > 0 && this.AuditId != NaN) {
        this.btnApproval = false;
        this.btnContractSave = false;
        this.savebtn = false;
        this.IsContract = false;
        ...
        if (this.Inserted == true) {
          if (ClientProjectMod.approvalStatusId == 8 || ClientProjectMod.approvalStatusId == 7 || ClientProjectMod.approvalStatusId == 1 || ClientProjectMod.approvalStatusId == 10) {
            ...
            if (ClientProjectMod.approvalStatusId != 1) {
              ...
              this.SAForm.controls.ContractRemarks.setValue(ClientProjectMod.remarks);
              this.SAForm.controls.ContractStatusId.setValue(ClientProjectMod.approvalStatusId);
        ...
        if (this.ProjectId > 0 && this.Inserted == true && ClientProjectMod.approvalStatusId == 5 || ClientProjectMod.approvalStatusId == 6) {
          this.deletebtn = true;
    ...
    if(parseInt(ClientProjectMod.approvalStatusId) ==1 || parseInt(ClientProjectMod.approvalStatusId)>6 )
    {
  ...
  loadClientSites(): void {
    ...
    if (this.ClientId > 0 && this.ClientId != null && this.ClientId != undefined) {
      ...
      this._SA8000Service.GetAllClientSites(this.ClientId).subscribe((Response) => {
  ...
  onSubmit1(): void {
    ...
    Object.keys(this.SAForm.controls).forEach(key => {
      ...
      if (this.SAForm.controls[key].value != null && this.SAForm.controls[key].value != "" && this.SAForm.controls[key].value != undefined && this.SAForm.controls[key].value != NaN) {
        var sname = key;
  ...
  onChange(deviceValue) {
    ...
    this._ClientService.GetSiteById(deviceValue).subscribe((Response) => {
      ...
      this.SAForm.controls.OutsourceProductionProcessess.setValue(Response.outsourceProductionProcessess);
  ...
  OnApprovalSubmit(): void {
    ...
    if (this.SAForm.get('ApprovalStatusId').value > 0 && this.SAForm.get('Remarks').value != null && this.SAForm.get('Remarks').value != '' && this.SAForm.get('Remarks').value != undefined && this.SAForm.get('Remarks').value != "" && this.SAForm.get('Remarks').value != NaN) {
      ...
      this._SA8000Service.ApprovedProject(ClientSitesModel).subscribe((Response) => {
      ...
      this._toster.error("Approval Status and Remarks can not be Empty", "Alert")
    }
  }
  ...
  DownloadApplicationForm(): void {
    ...
    // var fillename=e.row.data.title;
    var fillename = "Document File";
    this._SA8000Service.downloadApplicationForm(this.ProjectId).subscribe((result: Blob) => {
      const Blb = new Blob([result], { type: result.type });
      // const url=window.URL.createObjectURL(Blb);
      // window.open(url);
      // console.log("success");
  ...
  delete(): void {
    ...
    //         this._SA8000Service.DeleteProject(this.ProjectId).subscribe((Response) => {
  ...
  Pdf() {
    ...
    let clientSite = this.ClientSiteList.find(x => x.id == this.SAForm.get('ClientSiteId').value)
      ...
      content: [

        {
          columns: [
            ...
            { text: 'Code: ' + this.SAForm.get('Code').value + '\n' + 'Date: ' + TodayDate, },
        ...
        {
          text: 'Thank you for choosing us for taking an opportunity to present us certification SA8000:2014 in your esteemed organisation.' + '\n \n '
...

        {
          ...
          table: {
            ...
            //fontSize: 11,
            body: [
              [{ text: 'Organization Details ', style: 'tableHeader', colSpan: 2, alignment: 'center', color: 'white', fillColor: '#4258ad', fontSize: 11, }, {}],

              [{ text: 'Scope', style: 'tableHeader', alignment: 'left' }, { text: this.projectinfo.scope, style: 'tableHeader', alignment: 'left' }],

              [{ text: 'No of Employees', style: 'tableHeader', alignment: 'left' }, { text: this.clientsite.totalEmployees, style: 'tableHeader', alignment: 'left' }],

              [{ text: 'No of Site', style: 'tableHeader', alignment: 'left' }, { text: '1', style: 'tableHeader', alignment: 'left' }],
...

        {
          ...
          table: {
            ...
            body: [
              ...
              [{ text: 'Application fee  ', fontSize: 11, margin: [0, 3, 0, 0], }, { text: this.SAForm.get('ApplicationFee').value }],
              [{ text: 'Audit fee', fontSize: 11, bold: false, margin: [0, 3, 0, 0], }, { text: this.SAForm.get('AuditFee').value }],
              [{ text: 'Cost of Each Annual Surveillance Audits', fontSize: 11, bold: false, margin: [0, 3, 0, 0], }, { text: this.SAForm.get('SurveillanceAudits').value }],
              [{ text: 'GST/Local tax', fontSize: 11, margin: [0, 3, 0, 0], }, { text: this.SAForm.get('tax').value }],
            ],
            //alignment: "center",
          },
          layout: {
        ...
        {
          text: '•	All Surveillance audits shall be Semi Announced.' + '\n'
  ...
  onContractSubmit(): void {
    ...
    try {
     ...
     // }
      ...
      // this.SLCPForm.controls.File.setValue("");
      this._toster.error("File Name Is Incorrect", "Please Upload Correct File")
