...
@Component({
  ...
  styleUrls: ['./slcp.component.css']
})
export class SlcpComponent implements OnInit {

  // public UserAudit: UserAuditModel = new UserAuditModel();
  SLCPForm = new FormGroup({
    ...
    //CompletedModuleId: new FormControl(''),
    ...
    // WindowPeriodDate: new FormControl(''),
  ...
  //get input() { return this.SLCPForm.get('NoOfMd'); }
  //get ClientSiteId(){return this.SLCPForm.get('ClientSiteId')}
  ...
  onSubmit() {
    ...
    var date2 = new Date(this.SLCPForm.get('ToDate').value); 
      ...
      if(Days<15)
      {
        this._toster.info("Duration should minimum 15 days between 'From Date' and 'To Date'")
      }
else{
  ...
  public SerivceTypeList = [];
  public MethodologyList = [];
  public AccreditationList = [];
  public CompletedSetupList = [];
  public AssessmentCompletedList = [];
 public ClientSiteData:any;
  public OrganizationId: number
  public RequestOfSiteList = [];
  public ModuleVersionList = [];
  public ModuleShareList = [];
  ...
  CheckReviewer()
{
    ...
    this._makerAuthorizerFormService.getSecRoleForm().subscribe((data) => {
     ...
     this.secRoleForm.authAllowed = true
      ...
      if (this.secRoleForm.insertAllowed == false) {
        ...
        //this.btnApproval = true
        //this.authorizer = true
        this.SLCPForm.get('ClientSiteId').disable();
        this.SLCPForm.get('VerificationTypeId').disable();
        this.SLCPForm.get('ProjectTypeId').disable();
        this.SLCPForm.get('ServicesTypeId').disable();
        this.SLCPForm.get('MethodologyId').disable();
        this.SLCPForm.get('FromDate').disable();
        this.SLCPForm.get('ToDate').disable();
        this.SLCPForm.get('ApplicationDate').disable();
        this.SLCPForm.get('AssessmentCompletedId').disable();
        this.SLCPForm.get('AssessmentCompletedId').disable();
        // this.SLCPForm.get('CompletedModuleId').disable();
        this.SLCPForm.get('CompletedStepId').disable();
        this.SLCPForm.get('TentativeDate').disable();
        this.SLCPForm.get('NoOfMd').disable();
        this.SLCPForm.get('ModuleVersionId').disable();
        this.SLCPForm.get('BodySelectDate').disable();
        this.SLCPForm.get('ModuleShareId').disable();
        // this.SLCPForm.get('WindowPeriodDate').disable();
        this.SLCPForm.get('ModuleYear').disable();
        this.SLCPForm.get('RequestOfSiteId').disable();
  ...
  UpdateProject()
  {
    ...
    this._SlcpService.GetProjectSLCPBYId(this.ProjectId).subscribe(data => {
      ...
      this.cllientSiteId=this.ClientSiteData.id
      this.SLCPForm.controls.Address.setValue(this.ClientSiteData.address);
      this.SLCPForm.controls.OutsourceProductionProcessess.setValue(this.ClientSiteData.outsourceProductionProcessess);
      this.SLCPForm.controls.ShiftTimings.setValue(this.ClientSiteData.shiftTimings);
      this.SLCPForm.controls.ClientSiteId.setValue(this.ClientSiteData.id);
      this.SLCPForm.controls.LegalStatus.setValue(this.ClientSiteData.legalStatus)
      this.SLCPForm.controls.TotalEmployees.setValue(this.ClientSiteData.totalEmployees)

      this.SLCPForm.controls.VerificationTypeId.setValue(ClientProjectMod.verificationTypeId);
      if(ClientProjectMod.projectTypeId==1)
      {
       this.SLCPForm.controls.ProjectTypeId.setValue(ClientProjectMod.projectTypeId);
      }
      else
      {
       this.SLCPForm.controls.ProjectTypeId.setValue(0);

      }
     // this.SLCPForm.controls.ProjectTypeId.setValue(ClientProjectMod.projectTypeId);
      // this.SLCPForm.controls.ApplicationDate.setValue(ProjectSaData.applicationDate);
      if (ProjectSaData.applicationDate != null && ProjectSaData.applicationDate != "" && ProjectSaData.applicationDate != undefined && ProjectSaData.applicationDate != NaN) {
        ...
        this.SLCPForm.controls.ApplicationDate.setValue(this.datePipe.transform(application_Date, 'yyyy-MM-dd'))
      }
      this.SLCPForm.controls.ModuleShareId.setValue(ProjectSaData.moduleShareId);
      this.SLCPForm.controls.ModuleYear.setValue(ProjectSaData.moduleYear)
      // this.SLCPForm.controls.ToDate.setValue(ProjectSaData.ToDate)
      if (ProjectSaData.toDate != null && ProjectSaData.toDate != "" && ProjectSaData.toDate != undefined && ProjectSaData.toDate != NaN) {
        ...
        this.SLCPForm.controls.ToDate.setValue(this.datePipe.transform(To_Date, 'yyyy-MM-dd'))
      }
      this.SLCPForm.controls.MethodologyId.setValue(ProjectSaData.methodologyId);

      //this.SLCPForm.controls.FromDate.setValue(ProjectSaData.fromDate)
      if (ProjectSaData.fromDate != null && ProjectSaData.fromDate != "" && ProjectSaData.fromDate != undefined && ProjectSaData.fromDate != NaN) {
        ...
        this.SLCPForm.controls.FromDate.setValue(this.datePipe.transform(from_Date, 'yyyy-MM-dd'))
      }
      ...
      //   let windowPeriod_Date = new Date(this.datePipe.transform(ProjectSaData.windowPeriodDate, 'yyyy/MM/dd'))

      //   this.SLCPForm.controls.WindowPeriodDate.setValue(this.datePipe.transform(windowPeriod_Date, 'yyyy-MM-dd'))
      // }
      this.SLCPForm.controls.Remarks.setValue(ProjectSaData.remarks);
      this.SLCPForm.controls.ServicesTypeId.setValue(ProjectSaData.servicesTypeId);
      this.SLCPForm.controls.AssessmentCompletedId.setValue(ProjectSaData.assessmentCompletedId)
     ...
     this._HiggService.GetALLModuleVersion(ClientProjectMod.standardId).subscribe((Response)=>{
      ...
      this.SLCPForm.controls.ApprovalStatusId.setValue(ClientProjectMod.approvalStatusId);
      this.SLCPForm.controls.RequestOfSiteId.setValue(ProjectSaData.requestOfSiteId);

      this.SLCPForm.controls.Code.setValue(ClientProjectMod.projectCode);
      this.ProjectCode=ClientProjectMod.projectCode

      this.SLCPForm.controls.AccreditationId.setValue(ProjectSaData.accreditationId);
      this.SLCPForm.controls.CompletedStepId.setValue(ProjectSaData.completedStepId);
      //this.SLCPForm.controls.TentativeDate.setValue(ProjectSaData.tentativeDate);

      let req = new Date(this.datePipe.transform(ProjectSaData.tentativeDate, 'yyyy/MM/dd'))

      this.SLCPForm.controls.TentativeDate.setValue(this.datePipe.transform(req, 'yyyy-MM-dd'))
      ...
      if (this.secRoleForm.insertAllowed == true) {
        if (ClientProjectMod.approvalStatusId == 8 || ClientProjectMod.approvalStatusId == 7 || ClientProjectMod.approvalStatusId == 1 || ClientProjectMod.approvalStatusId == 10 ) {
          ...
          this.SLCPForm.get('ContractStatusId').disable();
          this.SLCPForm.controls.ApprovalStatusId.setValue(1);
          if (ClientProjectMod.approvalStatusId != 1) {

            this.SLCPForm.controls.ContractRemarks.setValue(ClientProjectMod.remarks);
            this.SLCPForm.controls.ContractStatusId.setValue(ClientProjectMod.approvalStatusId);
        ...
        //   this.SLCPForm.get('ApprovalStatusId').disable();
        //   this.SLCPForm.get('Remarks').disable();
        // }
      }
      ...
      if (ClientProjectMod.approvalStatusId == 1 || ClientProjectMod.approvalStatusId == 5) {
        this.btnApproval = false
      }
...
if(ClientProjectMod.approvalStatusId == undefined ||ClientProjectMod.approvalStatusId == "" ||ClientProjectMod.approvalStatusId == null ||ClientProjectMod.approvalStatusId == 2 || ClientProjectMod.approvalStatusId == 4)
{
this.Inserted=false
this.btnApproval=true
      ...
      if (this.ProjectId > 0 && this.secRoleForm.insertAllowed == true && ClientProjectMod.approvalStatusId == 5 || ClientProjectMod.approvalStatusId == 6) {
        this.deletebtn = true;
      ...
      if (ClientProjectMod.approvalStatusId == 7) {
        this.disableRecord()
      }
  ...
  loadAllApprovalStatus(): void {
    ...
    this._SlcpService.GetALLProjectStatus(roleId).subscribe((Response) => {
...
debugger
    if (this.ClientId > 0 && this.ClientId != null && this.ClientId != undefined) {
      ...
      this._SlcpService.GetAllClientSites(this.ClientId).subscribe((Response) => {
        ...
        if(this.cllientSiteId>0)
        {
          this.SLCPForm.controls.ClientSiteId.setValue(this.cllientSiteId);
        }
      })
    }
  }
  loadProjectType(): void {
    ...
    this._SlcpService.GetAllProjectType().subscribe((Response) => {
  ...
  LoadCompletedSetup(): void {
    ...
    this._SlcpService.GetALLCompletedSetup().subscribe((Response) => {
      this.CompletedSetupList = Response

    })
  }
  loadVerificationType(): void {

    this._SlcpService.GetAllVerificationType().subscribe((Response) => {
  ...
  onSubmit1(): void {
    ...
    Object.keys(this.SLCPForm.controls).forEach(key => {

      if (this.SLCPForm.controls[key].value != null && this.SLCPForm.controls[key].value != "" && this.SLCPForm.controls[key].value != undefined && this.SLCPForm.controls[key].value != NaN) {
        var sname = key;
        //var sname= this.SLCPForm.controls[key].;
        var val = this.SLCPForm.controls[key].value;

        foData.append(sname, val);
      }
    });

    // foData.append('ClientSiteId',this.SLCPForm.get('ClientSiteId').value);
    //  foData.append('VerificationTypeId',this.SLCPForm.get('VerificationTypeId').value);
    //  foData.append('ProjectTypeId',this.SLCPForm.get('ProjectTypeId').value);
    //  foData.append('ServicesTypeId',this.SLCPForm.get('ServicesTypeId').value);
    //  foData.append('MethodologyId',this.SLCPForm.get('MethodologyId').value);
    //  foData.append('FromDate',this.SLCPForm.get('FromDate').value);
    //  foData.append('ToDate',this.SLCPForm.get('ToDate').value);
    //  foData.append('ApplicationDate',this.SLCPForm.get('ApplicationDate').value);
    //  //foData.append('CompletedModuleId',this.SLCPForm.get('CompletedModuleId').value);
    //  foData.append('AccreditationId',this.SLCPForm.get('AccreditationId').value);
    //  foData.append('TentativeDate',this.SLCPForm.get('TentativeDate').value);


    //   foData.append('AssessmentCompletedId',this.SLCPForm.get('AssessmentCompletedId').value);
    // // foData.append('CompletedModuleId',this.SLCPForm.get('CompletedModuleId').value);

    //  foData.append('NoOfMd',this.SLCPForm.get('NoOfMd').value);
    //  foData.append('ModuleVersionId',this.SLCPForm.get('ModuleVersionId').value);
    //  foData.append('BodySelectDate',this.SLCPForm.get('BodySelectDate').value);
    //  foData.append('ModuleShareId',this.SLCPForm.get('ModuleShareId').value);
    //  foData.append('WindowPeriodDate',this.SLCPForm.get('WindowPeriodDate').value);
    //  foData.append('ModuleYear',this.SLCPForm.get('ModuleYear').value);
    //  foData.append('RequestOfSiteId',this.SLCPForm.get('RequestOfSiteId').value);
    //  foData.append('StandardId',this.standardId.toString());
    //  foData.append('CompletedStepId',this.SLCPForm.get('CompletedStepId').value);

    //  foData.append('Remarks',this.SLCPForm.get('Remarks').value);
    //foData.append('ApplicationForm',this.fileToUpload);



    this._SlcpService.ProjectSlcpCreateWithFile(foData).subscribe((Response) => {
  ...
  //       this.UserAuditForm.controls.TentativeDate.setValue(e.row.data.TentativeDate);
  ...
  //   this.UserAuditForm.controls.TentativeDate.setValue('');
  ...
  DiscountTypeChange($event) {
    ...
    this._toster.info("the selected value is " + $event.value);
  }
  ...
  onChange(deviceValue) {
    ...
    this._ClientService.GetSiteById(deviceValue).subscribe((Response) => {
      ...
      this.SLCPForm.controls.Address.setValue(Response.address);
      this.SLCPForm.controls.OutsourceProductionProcessess.setValue(Response.outsourceProductionProcessess);
      this.SLCPForm.controls.ShiftTimings.setValue(Response.shiftTimings);

      this.SLCPForm.controls.LegalStatus.setValue(Response.legalStatus)
      this.SLCPForm.controls.TotalEmployees.setValue(Response.totalEmployees)
  ...
  OnApprovalSubmit(): void {
...

    {
      ...
      ApprovalStatusId: this.SLCPForm.get('ApprovalStatusId').value,
      Remarks: this.SLCPForm.get('Remarks').value,
      RemarksById: LoginUserId.toString(),

    };


    this._SlcpService.ApprovedProject(ClientSitesModel).subscribe((Response) => {
  ...
  DownloadApplicationForm(): void {
    ...
    this._SlcpService.downloadApplicationForm(this.ProjectId).subscribe((result: Blob) => {
  ...
  delete(): void {
    ...
    // if (this.ProjectId != 0 && this.ProjectId != null && this.ProjectId != undefined) {
  ...
  loadRequestOfSite(): void {
    ...
    this._SlcpService.GetALLRequestOfSite().subscribe((Response) => {
      this.RequestOfSiteList = Response
  ...
  loadAssessmentCompleted(): void {
    ...
    this._HiggService.GetALLAssessmentCompleted().subscribe((Response) => {
      this.AssessmentCompletedList = Response
  ...
  Pdf() {
    ...
    let completestep = this.CompletedSetupList.find(x => x.id == this.SLCPForm.get('CompletedStepId').value)
    let methodology = this.MethodologyList.find(x => x.id == this.SLCPForm.get('MethodologyId').value)

    let clientSite = this.ClientSiteList.find(x => x.id == this.SLCPForm.get('ClientSiteId').value)
    //var clientinfo;
      ...
      content: [

        {
          columns: [
            ...
            { text: 'Code: ' + this.SLCPForm.get('Code').value + '\n' + 'Date: '+ TodayDate, },
        ...
        { canvas: [{ type: 'line', x1: 160, y1: 0, x2: 335, y2: 0, lineWidth: 3 }] },
        ...
        { canvas: [{ type: 'line', x1: 0, y1: 0, x2: 495, y2: 0, lineWidth: 1 }] },

        {
          text: this.clientinfo.contactPerson + "  (" + this.clientinfo.position + ")",
          //alignment: "left",
          fontSize: 11,
          //decoration: "underline" ,
          //bold : true,
        ...
        {
          text: 'Thank you for choosing us for taking an opportunity to present us certification of SLCP verification in your esteemed organization.' + '\n'
            + 'Among the range of certifications, The Ozone has accredited scheme certification of SA8000:2014 thru SAAS. We have approval as HIG Index Verifier Body and Social Labour Convergence Program (SLCP) as Verifier Body in Environmental and Social Assessments in Industry. We are doing assessments and '
            + 'certifications in ISO 9001:2015 for Quality Management Systems, ISO 14001:2015 for Environmental '
            + 'Management Systems, ISO 45001:2018 Occupational Health and Safety Management System, ISO '
            + '22000:2018 FSMS, ISO 18001: OHSAS for Health & Safety, HACCP and ISO 13485:2016.' + '\n'
            + 'The Ozone fosters a ‘listening philosophy ‘to be administered by its full support before and after the '
            + 'certification by working with you, as you further improve your systems, streamline your processes & '
            + 'strengthen your position as a world class organization. Also, as a value addition various training programs '
            + 'and workshops are conducted to enhance better understanding of the standard and imbibing it to '
            + 'seamless and integrated organizational development.' + '\n'
            + 'We are enclosing our proposal for certification with SLCP Verification with all details.' + '\n'
            + 'We are pleased to respond your queries in this regard.' + '\n'
            + 'Regards' + '\n'
            + 'Ozone Sustainability Management System' + '\n'
            + 'Pakistan',
          fontSize: 12,
          alignment: 'justify',
          margin: [0, 11, 0, 0]
        ...
        },
        {
          ...
          columns: [
            ...
            {
              text: this.clientinfo.siteCount,
              margin: [0, 5, 0, 0]
            },
          ],
        ...
        },
        {
          columns: [
            ...
            {
              text: this.SLCPForm.get('TotalEmployees').value,
              margin: [0, 2, 0, 0]
            },
          ],
        },
        ...
        '\n',
        {
          ...
          table: {
            ...
            body: [
              [{
                text: 'Service Type', alignment: 'center', color: 'white', margin: [0, 10, 0, 0],
                fillColor: '#4258ad',
              }, {
                text: 'Charges' + '\n' + 'USD/-', alignment: 'center', color: 'white',
                fillColor: '#4258ad', margin: [0, 3, 0, 0],
              }],
              [{ text: 'SLCP Verification Charges + SLCP Fee  ', fontSize: 11, margin: [0, 3, 0, 0], }, ''],
              [{ text: 'TOTAL + GST', fontSize: 11, bold: true, margin: [0, 3, 0, 0], }, '']
            ],
            //alignment: "center",
          },
          layout: {
        ...
        },
        {
          ...
          ul: [
            'The prices quoted in USD and the Invoices will be issued in Local Currency: USD. The rate of convergence will be applied at current rates on the invoice day. ',
        ...
        // },
        {
          ...
          columns: [
            ...
            { canvas: [{ type: 'line', x1: 0, y1: 0, x2: 150, y2: 0, lineWidth: 1, }], width: 340 },
...

        {
          columns: [
            ...
            {
              text: this.clientinfo.contactPerson + '\n' + this.clientinfo.position + '\n' + 'Cell #:' + this.clientinfo.mobileNumber + '\n' + 'Email:' + this.clientinfo.email,
              alignment: "left",
              fontSize: 10,
              //decoration: "underline" ,
              bold: true,
    ...
    const pdfFile = pdfmake.createPdf(documentDefinition, null, null, pdfFonts.pdfMake.vfs);
    pdfFile.open();
    ...
    try{
      ...
      if(fileName==this.ProjectCode)
      {
        ...
        if (this.fileToUpload == null || this.fileToUpload == undefined || this.fileToUpload == "" || this.fileToUpload == '' || this.fileToUpload == NaN) {
          ...
          this._toster.error("Contract file is required", "Please Upload Contract File");
          return;
        }
        ...
        this._toster.error("File Name Is Incorrect, Project code must be include in File name. File name must be  "+this.ProjectCode +"_Contract File", "Please Upload Correct File")
    }
  ...
  contractApproved(): void {
    ...
    if (this.SLCPForm.get('ContractStatusId').value == null || this.SLCPForm.get('ContractStatusId').value == undefined || this.SLCPForm.get('ContractStatusId').value == "" || this.SLCPForm.get('ContractStatusId').value == '' || this.SLCPForm.get('ContractStatusId').value == NaN) {

      this._toster.error("Contract Status is required", "Please Select Status");
      return;
    }
    ...
    this._SlcpService.ContractApproval(foData).subscribe((Response) => {
      ...
      {
          this._toster.info("Project amount not set in Project Amount form for this Standard!")
          ///this.router.navigateByUrl('/app/pages/sales/all-projects?'+this.ClientId);
      }
      else if(Response.message=='0')
      {
  ...
  contractDownload(): void {
    ...
    // var fillename=e.row.data.title;
    var fillename = "Document File";
    this._SlcpService.downloadContract(this.ProjectId).subscribe((result: Blob) => {
      const Blb = new Blob([result], { type: result.type });
      // const url=window.URL.createObjectURL(Blb);
      // window.open(url);
      // console.log("success");
